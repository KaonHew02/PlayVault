...
(function (PV) {
  ...
  const DICT = {
    en: {
      ...
      'room.shareCode': 'Read these six digits out to whoever is playing.',
      ...
      'net.errNoAnswer': 'No room answered that code. Check the six digits, and that the host still has PlayVault open.',
      ...
      'worms.energy': 'Dash tail',
      'worms.kills': 'Worms beaten',
      'worms.edge': 'Arena edge',
      'worms.you': 'You',
      'worms.crowd': 'Crowd',
      'worms.quiet': 'Quiet',
      'worms.busy': 'Busy',
      'worms.controls': 'Aim with the mouse and hold the left button to dash — a dash burns your tail and drops it behind you. On a phone, drag anywhere to steer and tap ⚡. The arrow keys turn too.',
      ...
      'crowd.fields': 'Green Fields',
      'crowd.dunes': 'Dune Road',
      'crowd.keep': 'The Long Keep',
      'crowd.hint': 'Steer with the mouse, the arrow keys or the pads. Pick the gate that multiplies.',
      'crowd.stormed': 'The keep is yours',
    ...
    zh: {
      ...
      'net.errGeneric': '连接失败。',
      'net.errNoAnswer': '没有房间响应这个房号。确认六位数字，以及房主还开着 PlayVault。',
      'net.errFull': '房间已满。',
      ...
      'worms.quiet': '清静',
      'worms.busy': '拥挤',
      'worms.controls': '鼠标控制方向，按住左键冲刺——冲刺会消耗尾巴，掉落的部分变成食物；手机上拖动屏幕转向，点击 ⚡ 冲刺；方向键同样可用。',
      'worms.eaten': '撞上了别的蠕虫',
      ...
      'crowd.dunes': '沙丘路',
      'crowd.keep': '长堡',
      'crowd.hint': '用鼠标、方向键或按钮左右移动，选择能翻倍的门。',
      'crowd.stormed': '攻下城堡',
      'crowd.routed': '人潮被击溃',
