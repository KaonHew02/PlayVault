...
(function (PV) {
  ...
  const DICT = {
    en: {
      ...
      'worms.quiet': 'Quiet',
      'worms.busy': 'Busy',
      'worms.controls': 'Steer with the mouse or ← →. Hold Space to dash — a dash spends mass.',
      'worms.eaten': 'You ran into another worm',
      'worms.hitWall': 'You hit the wall',

      'solitaire.drawLabel': 'Deal',
      'solitaire.draw1': 'Draw one',
      'solitaire.draw3': 'Draw three',
      'solitaire.auto': 'Send home',
      'solitaire.winnable': 'Winnable',
      'solitaire.winnableHint': 'This deal was solved before it was dealt.',
    ...
    zh: {
      ...
      'worms.quiet': '清静',
      'worms.busy': '拥挤',
      'worms.controls': '用鼠标或 ← → 控制方向，按住空格冲刺，冲刺会消耗体量。',
      'worms.eaten': '撞上了别的蠕虫',
      'worms.hitWall': '撞到了边界',

      'solitaire.drawLabel': '发牌',
      'solitaire.draw1': '翻一张',
      'solitaire.draw3': '翻三张',
      'solitaire.auto': '自动收牌',
      'solitaire.winnable': '有解',
      'solitaire.winnableHint': '这一局在发牌前已验证可以解开。',
