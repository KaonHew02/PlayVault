...
(function (PV) {
  ...
  const DICT = {
    en: {
      ...
      'worms.quiet': 'Quiet',
      'worms.busy': 'Busy',
      'worms.controls': 'Aim with the mouse and hold the left button to dash. On a phone, drag anywhere to steer and tap ⚡. The arrow keys turn too.',
      ...
      'racing.controls': 'Arrows or WASD - up to accelerate, down to brake. '
        + 'Shift drifts for a boost, Space fires your item, R puts you back on the road.',
      'racing.item': 'Item',
      'racing.none': 'Empty',
      'racing.shield': 'Shield',
      'racing.shieldOn': 'Shield up',
      'racing.speed': 'Speed',
      'racing.coins': 'Coins',
      'racing.go': 'GO!',
      'racing.perfectStart': 'PERFECT START!',
      'racing.goodStart': 'Good start',
      'racing.jumpStart': 'Jumped the start!',
      'racing.ultra': 'ULTRA BOOST!',
      'racing.blocked': 'Blocked!',
      'racing.finalLap': 'FINAL LAP!',
    ...
    zh: {
      ...
      'worms.quiet': '清静',
      'worms.busy': '拥挤',
      'worms.controls': '鼠标控制方向，按住左键冲刺；手机上拖动屏幕转向，点击 ⚡ 冲刺；方向键同样可用。',
      'worms.eaten': '撞上了别的蠕虫',
      ...
      'racing.place': '名次',
      'racing.best': '最快单圈',
      'racing.controls': '方向键或 WASD，上加速，下刹车；Shift 漂移蓄力，空格使用道具，R 回到赛道。',
      'racing.item': '道具',
      'racing.none': '空',
      'racing.shield': '护盾',
      'racing.shieldOn': '护盾生效',
      'racing.speed': '速度',
      'racing.coins': '金币',
      'racing.go': '出发！',
      'racing.perfectStart': '完美起步！',
      'racing.goodStart': '起步不错',
      'racing.jumpStart': '抢跑了！',
      'racing.ultra': '究极加速！',
      'racing.blocked': '挡下了！',
      'racing.finalLap': '最后一圈！',
