...
(function (PV) {
  ...
  const DICT = {
    en: {
      ...
      'crowd.hint': 'Tap or press Space to run, then steer with the mouse, a finger, the arrow keys or the pads. Take the gate that multiplies, beat the red crowds, and bring down the king. Coins from each run buy upgrades at the start line.',
      'crowd.tapToRun': 'Tap to run',
      'crowd.drag': 'drag to steer',
      'crowd.shop': 'Upgrades',
      'crowd.upStart': 'Starting crowd',
      'crowd.upGate': 'Gate bonus',
      'crowd.upStartFx': '+{n} runners at the start',
      'crowd.upGateFx': '+{n} runners from each green gate',
      'crowd.lv': 'Lv {n}',
      'crowd.max': 'Max',
      'crowd.shopLater': 'The shop opens at the start line.',
      'crowd.earned': '+{n} coins',
      'crowd.play': 'Mode',
      'crowd.levels': 'Levels',
      'crowd.free': 'Free run',
      'crowd.level': 'Level {n}',
      'crowd.levelDone': 'Level {n} complete!',
    ...
    zh: {
      ...
      'crowd.dunes': '沙丘路',
      'crowd.keep': '长堡',
      'crowd.hint': '点击或按空格开跑，再用鼠标、手指、方向键或按钮左右移动。走能翻倍的门，打败红色人群，击倒国王。每局得到的金币可以在起跑线升级。',
      'crowd.tapToRun': '点击开跑',
      'crowd.drag': '拖动来转向',
      'crowd.shop': '升级',
      'crowd.upStart': '初始人数',
      'crowd.upGate': '加成门',
      'crowd.upStartFx': '开局多 {n} 人',
      'crowd.upGateFx': '每个绿门多 {n} 人',
      'crowd.lv': '{n} 级',
      'crowd.max': '已满',
      'crowd.shopLater': '回到起跑线才能升级。',
      'crowd.earned': '+{n} 金币',
      'crowd.play': '模式',
      'crowd.levels': '闯关',
      'crowd.free': '自由跑',
